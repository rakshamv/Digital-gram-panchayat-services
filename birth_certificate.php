			...
			<div class="collapse navbar-collapse" id="ab">
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="dropdown"><a href="#" data-toggle="dropdown">Add Certificate<span class="caret"></span></a>
						...
						<li class="active"><a href="birth_certificate.php">Birth Certficate</a></li>
			...
			<div class="form col-sm-6">
				<div class="panel panel-primary">
					<div class="panel-heading">
						...
						<h1 class="panel-title" align="center" ><span class="fa fa-user-o"></span>      &nbsp; Add Birth Certificate </h1>
					</div>

					<div class="b2 panel-body">


						<form method="POST" action="birth_certificate(db).php" class="form-horizontal" enctype="multipart/form-data">
						<?php  
							include 'config.php';
							include 'session.php';
					...
					<div class="form-group">
						...
						<div class="form-group">
							<div>
								<div class="col-sm-12">
								<label>certificate_issued_by_hospital</label>
								<input type="file" name="certificate_issued_by_hospital"  class="form-control" required />
								</div>
				...
				<div class="table">
					<table class="table table-responsive">
						<?php
							...
							$b="select * from birth_certificate where applicant_id=$id";
