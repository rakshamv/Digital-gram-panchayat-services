			...
			<div class="collapse navbar-collapse" id="ab">
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="dropdown"><a href="#" data-toggle="dropdown">Add Certificate<span class="caret"></span></a>
						...
						<li class="active"><a href="income certificate.php">Income Certficate</a></li>
			...
			<div class="form  col-sm-6">
				<div class="panel panel-primary">
					<div class="panel-heading">
						...
						<h1 class="panel-title" align="center" ><span class="fa fa-user-o"></span> &nbsp; Add Income Certificate</h1>
					</div>

					<div class="b2 panel-body">
						<form method="POST" 	action="income certificate(db).php" class="form-horizontal" enctype="multipart/form-data">
						...
						<div class="form-group">
								...
								<div class="col-sm-12">
									...
									<select name="select_ration_card" class="form-control" > 
				...
				<div class="form-group">	
								...
								<input type="text" required name="enter_ration_card" class="form-control disabled" />
								</div>
				</div>							
						...
						<div class="form-group">
								...
								<input type="file" name="upload_affidavit"  class="form-control" required />
								</div>
						...
						<div class="form-group">
								...
								<input type="file" name="upload_aadhar_card"  class="form-control" required />
								</div>
						...
						<div class="form-group">
								...
								<div class="col-sm-12">
								<label>Upload 6 Month's Bank Statement</label>
								<input type="file" name="upload_6Months_bank_statement"  class="form-control" required />
								</div>
				...
				<div class="table">
					<table class="table table-responsive">
						<?php
							...
							$b="select * from income_certificate where applicant_id=$id";
